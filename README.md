sms-validator: Assortment of technologies including Arquillian
========================
...
Minimum requirement to build this project is Java 7.0, Maven 3.1, and JBoss WildFly.
...
4. This will deploy `target/sms-validator.war` to the running instance of the server.
 

Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/sms-validator/>.
